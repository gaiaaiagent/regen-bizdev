/**
 * TEMPLATE: Credit Class Mapping (Act 2)
 *
 * Copy to your client's page directory and update data imports.
 * Optionally add MethodologyComparison rows and LiveQueryPanel suggestion.
 */

import { act2, primaryComparison } from '../../data/template'; // TODO: Replace with your client data
  ...
  return (
    <div className="space-y-6 pt-4">
      <p className="text-sm text-muted-foreground">
        TODO: Tab intro describing the mapping analysis context.
      </p>
      ...
      <Card>
        ...
        <CardContent>
          <ReadinessScore
            ...
            contextLine="TODO: Context line describing readiness state."
          />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <EvidenceDrawer
            query="TODO: KOI search query for credit class evidence"
            label="View Source Evidence"
          />
          {/* TODO: Add MethodologyComparison for each credit class match */}
          <MethodologyComparison
            creditClass="TODO: Credit class"
            clientMethodology="TODO: Client methodology name"
            rows={primaryComparison}
          />
        </CardContent>
      </Card>

      {/* Verra Comparison — choose framing: "supply-side" or "institutional" */}
      ...
      <div className="space-y-4">
        ...
        <KoiLivePanel
          ...
          searchQuery="TODO: KOI search query for client-relevant documents"
        />
        {/* TODO: Update highlightClasses with relevant credit class prefixes */}
        <LedgerLivePanel highlightClasses={['C01', 'BT']} />
        <LiveQueryPanel suggestion="TODO: default live query suggestion" />
      </div>
    </div>
  );
}
