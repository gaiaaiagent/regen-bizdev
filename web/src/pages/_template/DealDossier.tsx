/**
 * TEMPLATE: Deal Dossier (Act 1)
 *
 * Copy to your client's page directory and update the data import.
 */

import { act1 } from '../../data/template'; // TODO: Replace with your client data
  ...
  return (
    <div className="space-y-6 pt-4">
      <p className="text-sm text-muted-foreground">
        TODO: Tab intro describing what this dossier covers and how it was synthesized.
      </p>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <EvidenceDrawer
            query="TODO: KOI search query for supporting evidence"
        ...
        <Card className="border-primary/30 bg-primary/5">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              <a
                href="mailto:gregory@regen.network?subject=TODO%20Client%20Discovery%20Sprint"
              ...
              <span className="text-xs text-muted-foreground">Next step: 30-minute scoping call</span>
            </div>
          </CardContent>
        </Card>
      )}
      ...
      {/* Your First Credit — TODO: Update with client-specific credit details */}
      <FirstCreditCard
        creditClass="TODO: Credit class"
        projectName="TODO: First credit project name"
        location="TODO: Location details"
        metric="TODO: Primary metric and value"
        description="TODO: Description of first credit pathway."
      />
